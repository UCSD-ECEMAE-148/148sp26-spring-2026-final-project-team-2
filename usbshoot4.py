...
# Max speed control: Increased to allow faster, snappier catches
MAX_SERVO_STEP = 8.0  # Allowed degrees change per frame (Doubled from 4.0)
    ...
    try:
        while True:
            ...
            if ids is not None and len(ids) > 0:
                ...
                # Removed final output filter loop to allow instant servo response
                ...
                filtered_dx = 0.0
                filtered_dy = 0.0
                print(f"\r[FPS {fps:4.1f}] Scanning... No AprilTag visible.", end="")
